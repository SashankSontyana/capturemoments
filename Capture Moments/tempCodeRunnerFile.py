...
app = Flask(__name__)
app.secret_key = os.environ.get("FLASK_SECRET_KEY") or 'fallback-dev-key'
...
photographers = [
    {"id": "p1", "name": "babu", "skills": ["Wedding", "Portrait"], "image": "babu.jpg","location":"Hyderabad"},
    {"id": "p2", "name": "sana", "skills": ["Fashion", "Event"], "image": "sana.jpg","location":"Mumbai"},
    {"id": "p3", "name": "ben", "skills": ["All Events", "Event"], "image": "ben.jpg","location":"Benguluru"}
]
